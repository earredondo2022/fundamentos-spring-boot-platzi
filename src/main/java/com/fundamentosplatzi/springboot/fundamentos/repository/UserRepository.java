...
@Repository
public interface UserRepository extends PagingAndSortingRepository<User, Long> {///Pagination con Spring Boot (agregar)
///public interface UserRepository extends JpaRepository<User, Long> {
    ...
    /// Query Methods: el nombre del metodo es propio y recibe parametros definidos en @Query

    ///Pagination con Spring Boot (agregar)
    List<User> findAll();
